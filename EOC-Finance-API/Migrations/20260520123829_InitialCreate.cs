        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BishopName = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DioceseId = table.Column<long>(type: "bigint", nullable: false),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Churches_Dioceses_DioceseId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChurchAssets", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ChurchAssets_Churches_ChurchId",
                        column: x => x.ChurchId,
                        principalTable: "Churches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalDonatedAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    FirstDonationDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastDonationDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ChurchId = table.Column<long>(type: "bigint", nullable: false),
                    DonorTier = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Donors", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Donors_Churches_ChurchId",
                        column: x => x.ChurchId,
                        principalTable: "Churches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DioceseId = table.Column<long>(type: "bigint", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Users_Dioceses_DioceseId",
                        column: x => x.DioceseId,
                        principalTable: "Dioceses",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_IncomeRecords_Churches_ChurchId",
                        column: x => x.ChurchId,
                        principalTable: "Churches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_IncomeRecords_Users_CreatedBy",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChurchAssets_ChurchId",
                table: "ChurchAssets",
                column: "ChurchId");

            migrationBuilder.CreateIndex(
                name: "IX_Churches_DioceseId",
                table: "Churches",
                column: "DioceseId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IncomeRecords_ChurchId",
                table: "IncomeRecords",
                column: "ChurchId");

            migrationBuilder.CreateIndex(
                name: "IX_IncomeRecords_CreatedBy",
                table: "IncomeRecords",
                column: "CreatedBy");
